...
public final class AoscTestUtils {
    ...
    static Map<String, Object> responseAsMap(Response response) throws IOException {
        // HttpClient 5 (OpenSearch 3.x) EntityUtils.toString throws checked ParseException;
        // rethrow as IOException to keep this helper's signature stable for callers.
        final String body;
        try {
